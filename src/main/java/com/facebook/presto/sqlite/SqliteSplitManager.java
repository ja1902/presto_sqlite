        ...
        implements ConnectorSplitManager
{
            ...
            SplitSchedulingContext splitSchedulingContext)
    {
        ...
        // SQLite is a single-file database, so we use a single split per table
        ConnectorSplit split = new SqliteSplit(tableHandle.getSchemaName(), tableHandle.getTableName());
