...
if ($portInUse) {
    ...
    Write-Error "Port 8080 is already in use. Stop whatever is using it and re-run, or run:`n  docker start presto"
...
if (-not $prestoStarted) {
    ...
    Write-Error "Failed to start Docker container after 3 attempts. Make sure Docker Desktop is running."
